...
public class RemoteServiceProxyService {
	...
	private static RemoteServiceProxyService instance;
	...
	public static RemoteServiceProxyService getInstance(ServletContext application, String proxyHost) {
		if (instance == null) {
			instance = new RemoteServiceProxyService();
			if (proxyHost != null) {
				instance.proxyUrl = proxyHost;
			}
		}
		return instance;
	}
